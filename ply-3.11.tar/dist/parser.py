...
def p_bloque(p):
    '''
    bloque : LBRACK estatutos estatu_rec RBRACK
    '''
...
def p_point(p):
    '''
    point : POINT LPAREN INT_CTE COMMA INT_CTE RPAREN
    '''

def p_circle(p):
    '''
    circle : CIRCLE LPAREN INT_CTE RPAREN
    '''

def p_size(p):
    '''
    size : SIZE LPAREN INT_CTE RPAREN
    '''

def p_color(p):
    '''
    color : COLOR LPAREN INT_CTE COMMA INT_CTE COMMA INT_CTE RPAREN
    '''    